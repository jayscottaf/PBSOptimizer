...
CREATE INDEX "bid_packages_month_year_idx" ON "bid_packages" USING btree ("month","year");--> statement-breakpoint
CREATE INDEX "bid_packages_base_aircraft_idx" ON "bid_packages" USING btree ("base","aircraft");--> statement-breakpoint
CREATE INDEX "bid_packages_status_idx" ON "bid_packages" USING btree ("status");--> statement-breakpoint
CREATE INDEX "pairings_bid_package_idx" ON "pairings" USING btree ("bid_package_id");--> statement-breakpoint
CREATE INDEX "pairings_number_idx" ON "pairings" USING btree ("pairing_number");--> statement-breakpoint
CREATE INDEX "pairings_credit_hours_idx" ON "pairings" USING btree ("credit_hours");--> statement-breakpoint
CREATE INDEX "pairings_block_hours_idx" ON "pairings" USING btree ("block_hours");--> statement-breakpoint
CREATE INDEX "pairings_hold_probability_idx" ON "pairings" USING btree ("hold_probability");--> statement-breakpoint
CREATE INDEX "pairings_days_idx" ON "pairings" USING btree ("pairing_days");--> statement-breakpoint
CREATE INDEX "pairings_search_idx" ON "pairings" USING btree ("bid_package_id","credit_hours","block_hours");--> statement-breakpoint
CREATE INDEX "user_favorites_user_idx" ON "user_favorites" USING btree ("user_id");--> statement-breakpoint
CREATE INDEX "user_favorites_pairing_idx" ON "user_favorites" USING btree ("pairing_id");--> statement-breakpoint
CREATE INDEX "user_favorites_user_pairing_idx" ON "user_favorites" USING btree ("user_id","pairing_id");