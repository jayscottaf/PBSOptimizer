// Sample text from the NYC 220 AUG bid package for testing purposes
export const samplePdfText = `
NYC BASE               220 PILOT PAIRINGS 

#7990  MO              EFFECTIVE AUG04 ONLY                  CHECK-IN AT 10.28 
                                                                                
DAY   FLIGHT T  DEPARTS   ARRIVES C BLK.  TURN BLK/MAX FDP/MAX PWA FDP/MAX    
 A      1404    LGA 1128  CHS 1346  2.18   .50 221 M                         2  
                CHS 1436  LGA 1642  2.06  1.47                               2  
...
DAY   FLIGHT T  DEPARTS   ARRIVES C BLK.  TURN BLK/MAX FDP/MAX PWA FDP/MAX    
 A DH   2810    LGA 1130  ORD 1310  2.40  1.15 223                              
        1074    ORD 1425  LGA 1750  2.25  1.05     M                         2  
        2801    LGA 1855  ORD 2049  2.54           M 11.19/14.00 11.19/12.30 2  
                                                         2.40DHD 
...
DAY   FLIGHT T  DEPARTS   ARRIVES C BLK.  TURN BLK/MAX FDP/MAX PWA FDP/MAX    
 A      2801    LGA 1855  ORD 2047  2.52       223    3.52/12.00  3.52/11.30 2  
         ORD 14.42/PALMER HOUSE                  2.52/ 9.00  .00CRD  2.52TL    
 B      2894    ORD 1259  LGA 1630  2.31  1.00 221 M                         2  
        2705    LGA 1730  BNA 1914  2.44   .50     M                         2  
                BNA 2004  LGA 2326  2.22             10.27/13.00 10.27/12.30 2  
`;