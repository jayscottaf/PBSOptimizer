...
import { useNetworkStatus, NetworkHealthChecker } from '@/hooks/useNetworkStatus';
import { Alert, AlertDescription } from '@/components/ui/alert';
import { Button } from '@/components/ui/button';
import { WifiOff, Wifi, WifiLow, RefreshCw, AlertTriangle, CheckCircle } from 'lucide-react';
...
export function NetworkStatus({ className = '', showDetails = false }: NetworkStatusProps) {
  ...
  const getTooltipText = () => {
    if (!networkStatus.isOnline) return 'Offline - Using cached data';
  ...
  return (
    <div className={`${className}`}>
      ...
      {networkStatus.isOnline && networkStatus.isSlowConnection && showFullStatus && (
