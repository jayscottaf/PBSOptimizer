  ...
  return (
    <div className={`${className}`}>
        ...
        <div className="absolute top-10 right-0 w-72 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-lg p-4 z-50">
          ...
          <div className="text-gray-600 dark:text-gray-400 space-y-2 text-sm">
            ...
            {networkStatus.lastOnlineTime && (
              <div className="text-gray-500 dark:text-gray-500 text-xs pt-2 border-t dark:border-gray-700">
      ...
      {networkStatus.isOnline && lastSuccessfulSync && showFullStatus && (
        <div className="absolute top-10 right-0 w-64 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg shadow-lg p-3 z-50">
      ...
      {networkStatus.isOnline &&
        ...
        showFullStatus && (
          <div className="absolute top-10 right-0 w-64 bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg shadow-lg p-3 z-50">
            <div className="flex items-center gap-2 text-yellow-800 dark:text-yellow-300">
              <WifiLow className="h-4 w-4 text-yellow-600 dark:text-yellow-400" />
