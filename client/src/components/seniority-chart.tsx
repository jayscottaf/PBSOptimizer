    ...
    <Card>
      <CardContent className="p-6">
        <div className="flex items-center justify-between mb-6">
          <h3 className="text-lg font-semibold text-gray-900">Seniority Trends</h3>
        ...
        <div className="relative h-64 bg-gray-50 rounded-lg border border-gray-200 flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="text-gray-500">Seniority trend chart will display here</p>
            <p className="text-sm text-gray-400 mt-2">Shows historical award patterns for your seniority range</p>
          </div>
